...
export default async function SeasonBrowsePage({ params, searchParams }: SeasonPageProps) {
  if (!hasSupabaseConfig()) notFound();

  const { competition: competitionSlug, season: seasonSlug } = await params;
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6">
      <PageHeader
        ...
        title={interpolate(t.browse.season, { label: seasonLabel })}
        description={t.browse.seasonDescription}
      />
      ...
      <div className="grid gap-8 lg:grid-cols-[240px_1fr]">
        ...
        <section>
          {videos.length === 0 ? (
            <EmptyState message={t.browse.emptySeason} />
          ) : (
