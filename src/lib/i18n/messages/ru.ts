...
const ru: Messages = {
  ...
  home: {
    ...
    emptyVideos:
      "Обзоров пока нет. Нажмите «Обновить», чтобы загрузить видео с официальных каналов.",
    refresh: "Обновить обзоры",
    refreshing: "Обновление...",
    refreshSuccess: "Обзоры обновлены.",
    refreshSuccessNew: "Добавлено новых обзоров: {count}.",
    refreshError: "Не удалось обновить обзоры. Попробуйте снова.",
    refreshInProgress: "Обновление уже выполняется. Попробуйте чуть позже.",
  },
  browse: {
    eyebrow: "Турниры",
